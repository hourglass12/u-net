        ...
        for file_path in file_paths:
            if file_path.endswith(".png") or file_path.endswith(".jpg"):
                ...
                if init_size is not None and init_size != image.size:
                    if antialias:
                        image = image.resize(init_size, Image.LANCZOS)
                    else:
...
if __name__ == "__main__":
    dataset_loader = Loader(dir_original="../dataset/VOCdevkit/VOC2012/JPEGImages",
                            dir_segmented="../dataset/VOCdevkit/VOC2012/SegmentationClass")
